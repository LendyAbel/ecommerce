 ...
 * depender del catálogo actual. El stock, en cambio, se consulta en vivo
 * para avisar si ya no alcanza para cubrir la cantidad pedida.
 */
            ...
            <ul className='divide-border divide-y'>
                {items.map(item => {
                    const stock = item.productId
                        ? stockByProductId.get(item.productId)
                        : undefined;
