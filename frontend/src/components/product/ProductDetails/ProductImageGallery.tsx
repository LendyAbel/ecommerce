...
const statusConfig: Record<string, { label: string; className: string }> = {
    published: { label: 'Disponible', className: 'bg-green-100 text-green-700' },
    draft: { label: 'Borrador', className: 'bg-yellow-100 text-yellow-700' },
    discontinued: { label: 'Descatalogado', className: 'bg-gray-100 text-gray-500' },
};
        ...
        <div className='flex flex-col gap-3'>
            <div className='relative overflow-hidden rounded-2xl border border-gray-100 bg-gray-50'>
                {activeImage ? (
                    ...
                    <div className='flex h-105 items-center justify-center text-gray-300'>
